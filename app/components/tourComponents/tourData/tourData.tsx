export const pageData = {
    ...
    titleEN: "IMPULSE FELLOWSHIP PROGRAM",
    titleRU: "ИМПУЛЬСИВНАЯ СТИПЕНДИАЛЬНАЯ ПРОГРАММА",
    tourCost: "1000$",
    ru: {
        titleText: "Это не просто образовательная программа, а захватывающее путешествие для тех, кто уже познал вкус успеха.",
        tourDates: "12 - 15 Августа",
        chips: {
            first: "Места силы",
            second: "Глубокий эмоциональный опыт",
            third: "Форум-группы"
        },
        description: [
            {
                header: "Опыт, меняющий жизнь",
                text: "Участники совместно переживают глубокий эмоциональный опыт, который трансформирует их мышление и взгляды на жизнь."
            },
            {
                header: "Места силы",
                text: "Погружение в атмосферу единомышленников в знаменательном месте, наполненном мощной энергетикой, для закрепления полученных знаний."
            },
            {
                header: "Форум-группы",
                text: "Мощный метод личного роста и поддержки друг друга через конфиденциальные встречи. Освоите принципы работы форума и создавайте сообщества, которые будут вести вас к развитию более 10 лет."
            },
        ],
    ...
    ru: [
        {
            ...
            description: [
                {
                    text: "В 8:45 нас ждет сбор группы и отправление в Чон-Кемин в 9:00. По пути наш гид познакомит вас с культурой, историей и традициями нашей страны."
                },
                {
                    text: "По прибытии в уютный гостевой дом мы разместимся и немного отдохнем, после чего нас ждет увлекательное шоу с беркутом и вкусный обед."
                },
                {
                    text: "Затем ознакомимся с предстоящей программой тренинга. Обед и время для отдыха предусмотрены организаторами."
                },
                {
                    text: "День завершится прекрасным ужином и свободным временем для общения и отдыха."
                }
            ],
        ...
        },
        {
            ...
            description: [
                {
                    text: "В 8:00 нас ждет завтрак в гостевом доме."
                },
                {
                    text: "В 8:45 начинается сбор группы, и в 9:00 мы отправляемся в путешествие на Сон-Куль."
                },
                {
                    text: "По пути мы проедем по живописной дороге через Боомское ущелье и Ортококойское водохранилище, наслаждаясь великолепными видами до самого перевала."
                },
                {
                    text: "К 12:30 мы прибудем в юрточный лагерь, где нас ждет размещение, обед и первый блок тренинга."
                },
                {
                    text: "Вечером мы соберемся на ужин, а затем будем наслаждаться посиделками у костра под звездным небом."
                }
            ],
        ...
        },
        {
            ...
            description: [
                {
                    text: "В 9:00 нас ждет завтрак."
                },
                {
                    text: "С 10:00 начнется тренинг."
                },
                {
                    text: "В 14:00 мы соберемся на обед, после которого отправимся на конную прогулку к панорамным видам."
                },
                {
                    text: "Вечером нас ждет ужин, а затем свободное время для отдыха и общения."
                }
            ],
        ...
        },
        {
            ...
            description: [
                {
                    text: "В 9:00 нас ждет вкусный завтрак."
                },
                {
                    text: "В 10:00 начнется тренинг, который поможет раскрыть потенциал и углубить знания."
                },
                {
                    text: "В 14:00 мы соберемся на обед, где сможем насладиться блюдами местной кухни и обсудить впечатления от утренней сессии."
                },
                {
                    text: "После обеда – свободное время. Трек прогулка к древним петроглифам."
                },
                {
                    text: "В 16:00 мы выезжаем в Бишкек, наслаждаясь живописными видами по дороге и делясь впечатлениями."
                },
                {
                    text: "Прибытие в Бишкек запланировано на 21:00"
                }
            ],
            photo1: "https://kartinki.pics/pics/uploads/posts/2022-08/1659477759_3-kartinkin-net-p-ozero-alakol-kirgiziya-priroda-krasivo-fot-3.jpg",
            photo2: "https://ecotours.ru/assets/galleries/621/imgp6132-corr.jpg",
